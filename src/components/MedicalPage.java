...
public class MedicalPage implements Comparable, Page {
	...
	public String contractCode; // Optional (Specific to Anthem)

	public MedicalPage(int carrier_id, String carrier_plan_id, String start_date, String end_date, String product_name,
			...
			String outpatient_complex_imaging, String physical_occupupational_therapy, String group_rating_area,
			String service_zones, String state, int page, HashMap<String, Double> non_tob_dict,
			HashMap<String, Double> tob_dict) {

 ...
 */
public class DE_Aetna_Benefits implements Parser {
	...
	public DE_Aetna_Benefits(String s_date, String e_date) {
		start_date = s_date;
		end_date = e_date;
	}
	...
	public ArrayList<Page> parse(File file, String filename) throws IOException {
		...
		MedicalPage new_page = new MedicalPage(carrier_id, carrier_plan_id.toString(), start_date, end_date,
				...
				outpatient_complex_imaging.toString(), physical_occupational_therapy.toString(), "",
	...
	public StringBuilder formatString(StringBuilder input) {
		String[] delimiters = { "covered", "Not", "Urgent", "Emergency", ",", ".", "*", ";", ":", "person", "copay/",
				...
				"free", "for", "X-ray", "No", "charge", "day ", "Lab"};
	...
	public StringBuilder formatProductName(String x) {
		...
		String[] delims = { "Summary", "Of", "Benefit", "Coverage", ".", "pdf"};
		s = removeStrings(s, delims);
		return s;
	}

 ...
 */
public class UMPC_Parser {
	
	static String text;
	
	static UMPC_Page[] pages;
	...
	public UMPC_Parser(File file, String s_date, String e_date) throws IOException{
		start_date = s_date;
		end_date = e_date;
	    ...
	    pages = new UMPC_Page[numUMPC_Pages];
	}
	
	public UMPC_Page[] parse(){
...
//			        	System.out.println(tokens[i]);
			...
			UMPC_Page page = new UMPC_Page(start_date, end_date, rider, plan_code, page_index, rating_area, plan_name, state, non_tobacco_dict, tobacco_dict);

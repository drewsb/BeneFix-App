...
public class UPMC_Page {
	...
	public UPMC_Page(String s_date, String e_date, String rider, String code, int p, String rating, String name, String s, HashMap<String,Double> non_tobacco_rates,  HashMap<String,Double> tobacco_rates){
		start_date = s_date;
		end_date = e_date;

...
public class PA_UPMC_Rates {
	...
	public PA_UPMC_Rates(File file, String s_date, String e_date) throws IOException{
		start_date = s_date;
		end_date = e_date;
	    ...
	    pages = new PA_UPMC_Page[numUMPC_Pages];
	}
	
	public PA_UPMC_Page[] parse(){
...
//			        	System.out.println(tokens[i]);
			...
			PA_UPMC_Page page = new PA_UPMC_Page(start_date, end_date, rider, plan_code, page_index, rating_area, plan_name, state, non_tobacco_dict, tobacco_dict);
